...
hero:
  name: PPM
  text: Partner Process Monitoring
  tagline: Fast and efficient process monitoring tool for Docker
  actions:
    - theme: brand
      text: Quick Start
...
features:
  - title: User-Friendly
    details: Modular configuration with sensible defaults and a natural, intuitive CLI.
    icon: <i class="bi bi-chat-left-heart feature-logo text-4xl"></i>
    link: /quick_start/usage
  ...
  - title: Container-Ready
    details: Designed to run seamlessly in Docker and Podman environments.
    icon: <i class="bi bi-boxes feature-logo text-4xl"></i>
    link: /quick_start/installation
---
